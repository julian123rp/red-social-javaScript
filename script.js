...
let posts = [] // indicaremos los posteos con un array vacio 
...
function getData(){
    ...
    .then(data =>{
        posts = data
        renderPostList()
        //metodo para msotar la informacion en la pantalla 
    })
...
function postData(){
    ...
    if(postTitle.trim() == "" || postBody.trim() == ""){
        alert("los campos son obligatoios")
        return
    }
...
function updatePost(id){
    ...
    .catch(error => console.error("Error al querer actulizar posteo:" , error))
}
...
function deletePost(id){
    ...
    .then(res => {
        if(res.ok){
            ...
            alert("hubo un error y no se pudo elimar el posteo")
        }
    })
